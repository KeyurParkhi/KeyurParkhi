...
I’m a Statistics and Data Science postgraduate at SVKM’s NMIMS, currently working in Model Risk Management at Morgan Stanley as a Spring Analyst Intern, where I apply quantitative methods to evaluate and strengthen machine learning models in financial risk frameworks. My experience spans risk modeling, model validation, and financial analytics. I work with Python, R, and Excel to build and test models, perform backtesting, and assess model stability using metrics like AUC, Gini, and Recall. I’ve contributed to end-to-end model validation processes, including drift diagnostics, LOFO analysis, and performance monitoring, ensuring alignment with regulatory standards such as SR 11-7. Alongside this, I’ve developed portfolio analytics solutions computing returns, volatility, Alpha/Beta and improved backtesting efficiency by ~20% through code optimization. I’ve also built machine learning models across domains, including classification and regression problems, and conducted geospatial and financial data analysis to generate actionable insights. I’m particularly interested in roles at the intersection of Data Science, Risk Management, Risk Analytics, and Financial Modeling, where I can apply statistical thinking to real-world decision-making.
Open to opportunities, collaborations, and conversations in data-driven risk and analytics.
...
- **Libraries/Frameworks**: H2O, optuna, scikit-learn, XGBoost, LightGBM, matplotlib, seaborn, Plotly  
